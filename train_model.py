...
#         tf.keras.layers.Flatten(input_shape=(28, 28)),  # Capa de entrada (aplanar imagen 28x28)
#         tf.keras.layers.Dense(64, activation='relu'),  # Capa oculta con 64 neuronas y activación ReLU
#         tf.keras.layers.Dense(64, activation='relu'),  # Segunda capa oculta con 64 neuronas y activación ReLU
#         tf.keras.layers.Dropout(0.2),                   # Dropout para regularización
#         tf.keras.layers.Dense(10, activation='softmax')  # Capa de salida con 10 neuronas para 10 clases (dígitos del 0 al 9)
#     ])
#
#
#     # Compilar el modelo
